...
import java.util.*;
class MandN//initialization of class
{
    int sumDig(int n) // Function to find sum of digits of a number
    {
        int sum = 0, d;
        while(n>0)
        {
...
/*
Enter a value of 'm' from 100 to 10000 : 102
Enter a value of n from 1 to 99 : 11
The required number = 119
Total number of digits = 3

Enter a value of 'm' from 100 to 10000 : 1600
Enter a value of n from 1 to 99 : 25
The required number = 1699
Total number of digits = 4

Enter a value of 'm' from 100 to 10000 : 3654
Enter a value of n from 1 to 99 : 11
The required number = 3701
Total number of digits = 4
 */