...
// program to find number in array using binary search
...
class binary
{
    ...
    { 
        ...
        int val = input.nextInt();//inputs value from user
...
/*
 Enter number to initialize binary search
5
Output

The sorted array is :
1 2 4 5 6 7 8 9 10 11 13 14 16 17 19 20 22 23 25 26 27 29 32 34 37 42 
Number found, Search Successful
Value : 5
Index : 3
